...
##deleting the one of the dependent variable since our present is predicting the bias infuential factor
...
##modelling
predicted <- knn(train_dataset,test_dataset,cl = labels_train, k = 10)
